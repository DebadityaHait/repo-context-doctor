export type Provider = "codex" | "claude" | "cursor" | "gemini" | "copilot" | "windsurf";
...
export type Scan = { schemaVersion: 3; root: string; cwd: string; sources: Source[]; edges: GraphEdge[]; findings: Finding[]; contextBytes: Record<Provider, number>; confidence: number };
